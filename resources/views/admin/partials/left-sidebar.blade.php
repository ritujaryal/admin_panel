        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item {{$current_route=='index'?'menu-open':''}}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('companies.index')}}" class="nav-link {{$current_route=='companies.index'?'active':''}}">
                  <i class="far fas fa-user"></i>
                  <p>Companies</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('employees.index')}}" class="nav-link {{$current_route=='employees.index'?'active':''}}">
                  <i class="far fas fa-user"></i>
                  <p>Employees</p>
                </a>
              </li>
